...
Du=1;
Dv=0.06;    % changeable (0.06)
k1=11;      % changeable (11)
k2=11;
ubar=1+0.04*k2^2;    % steady state
vbar=0.2*k2;    % steady state
...
for pit=1:50    % # images
    ...
    for it=1:maxit
        ...
        % solve the equations
        nu(2:end-1,2:end-1)=u(2:end-1,2:end-1)+dt*(f+Du*func(u,h));
        nv(2:end-1,2:end-1)=v(2:end-1,2:end-1)+dt*(g+Dv*func(v,h));
